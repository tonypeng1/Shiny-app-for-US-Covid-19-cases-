1. Raw data of accumulated total Covid-19 cases (based on counties) from USAFACTS Covid-19 site and of population of each county from the census bureau site are uploaded each time the app is run. 
